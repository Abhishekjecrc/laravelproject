				...
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children active dropdown">
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-table"></i><a href="category">Category</a></li>
							<li><i class="fa fa-table"></i><a href="subcategory">Sub Category</a></li>
							<li><i class="fa fa-table"></i><a href="form">Details</a></li>
							<li><i class="fa fa-table"></i><a href="product">product</a></li>
						</ul>
					</li>
